...
${OBJECTDIR}/_ext/56749130/ALogger.o: /home/xaqq/logger/logger/ALogger.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/56749130/ALogger.o /home/xaqq/logger/logger/ALogger.cpp

${OBJECTDIR}/_ext/56749130/DefaultFilter.o: /home/xaqq/logger/logger/DefaultFilter.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/56749130
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/56749130/DefaultFilter.o /home/xaqq/logger/logger/DefaultFilter.cpp

${OBJECTDIR}/_ext/56749130/DefaultFormatter.o: /home/xaqq/logger/logger/DefaultFormatter.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/56749130
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/56749130/DefaultFormatter.o /home/xaqq/logger/logger/DefaultFormatter.cpp

${OBJECTDIR}/_ext/56749130/StdoutLogger.o: /home/xaqq/logger/logger/StdoutLogger.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/56749130
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/56749130/StdoutLogger.o /home/xaqq/logger/logger/StdoutLogger.cpp
